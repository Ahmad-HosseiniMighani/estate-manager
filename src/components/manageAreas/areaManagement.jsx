...
class AreaManagement extends Form {
    ...
    async componentDidMount() {
        ...
        // });
        try {
            const result = await auth.getAllAreas();
            // console.log(result)
            const areas = result;
    ...
    handleEdit = (area) => {
        window.location = process.env.PUBLIC_URL + "/edit-area/" + area.id+"/"+area.area_name;
    };
    // handleView = (area) => {
    ...
    render() {
        ...
        return (
            <React.Fragment>
                ...
                />
                {isLoggedIn && (<section id="area-management" dir="rtl">
